 ...
 * \file
 *
 * \brief NMEA Multiplexer v2.1 board definition
 *
 */
...
// LED's
#define LED_BT_TX_PIN			  IOPORT_CREATE_PIN(PIOB,  9)
#define LED_BT_RX_PIN			  IOPORT_CREATE_PIN(PIOA,  2)
#define LED_PORT_1_ERR_PIN	IOPORT_CREATE_PIN(PIOA, 24)
#define LED_PORT_1_RX_PIN		IOPORT_CREATE_PIN(PIOB, 13)
#define LED_PORT_1_TX_PIN		IOPORT_CREATE_PIN(PIOB,  8)
#define LED_PORT_2_ERR_PIN	IOPORT_CREATE_PIN(PIOA, 14)
#define LED_PORT_2_RX_PIN		IOPORT_CREATE_PIN(PIOA, 20)
#define LED_PORT_2_TX_PIN		IOPORT_CREATE_PIN(PIOA, 11)
#define LED_PORT_3_ERR_PIN	IOPORT_CREATE_PIN(PIOA, 18)
#define LED_PORT_3_RX_PIN		IOPORT_CREATE_PIN(PIOA, 19)
#define LED_PORT_3_TX_PIN		IOPORT_CREATE_PIN(PIOA, 17)
#define LED_PORT_4_ERR_PIN	IOPORT_CREATE_PIN(PIOA, 30)
#define LED_PORT_4_RX_PIN		IOPORT_CREATE_PIN(PIOA, 29)
#define LED_PORT_4_TX_PIN		IOPORT_CREATE_PIN(PIOA, 16)
#define LED_PORT_5_ERR_PIN	IOPORT_CREATE_PIN(PIOB, 14)
#define LED_PORT_5_RX_PIN		IOPORT_CREATE_PIN(PIOB, 15)
#define LED_PORT_5_TX_PIN		IOPORT_CREATE_PIN(PIOA, 31)
